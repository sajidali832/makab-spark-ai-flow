...
const HistorySection = () => {
  ...
  const getTypeGradient = (type: string) => {
    const gradients: Record<string, string> = {
      ...
      'Email Subject Lines': 'from-emerald-500 to-teal-500',
      'Thread Generator': 'from-violet-500 to-purple-500',
      'LinkedIn Post': 'from-blue-600 to-indigo-600',
      'Image Prompt': 'from-pink-500 to-red-500',
      'SEO Title Generator': 'from-green-600 to-emerald-600',
      ...
      'email-subject': 'from-emerald-500 to-teal-500',
      'thread-generator': 'from-violet-500 to-purple-500',
      'linkedin-post': 'from-blue-600 to-indigo-600',
      'image-prompt': 'from-pink-500 to-red-500',
      'seo-title': 'from-green-600 to-emerald-600',
